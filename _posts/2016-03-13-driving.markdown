...
_EDIT_: It seems to be a law or courtesy on the highway (at least 3 lanes) to
leave the outermost lane empty and only use it to overtake. The best solution
would be to leave it empty however we rarely have 3 lanes and when we have
people don't use it *only* to overtake, they just drive normally on it.
...
According to new statistics Lebanon is second worse country for the death toll of traffic related death ( 1500 deaths in 2015 .)
